export default function Contact() {
  return <><section className="contact-section" id="contact" aria-labelledby="contact-title">
    ...
    <div className="contact-links">
      ...
      <a href="https://www.linkedin.com/in/alikhanmussin" target="_blank" rel="noreferrer"><span>LinkedIn</span><strong>Alikhan Mussin</strong><span aria-hidden="true">↗</span></a>
      <a href="https://github.com/alikhanmussin" target="_blank" rel="noreferrer"><span>GitHub</span><strong>alikhanmussin</strong><span aria-hidden="true">↗</span></a>
    </div>
  </section><footer className="site-footer"><span>© {new Date().getFullYear()} Alikhan Mussin</span><a href="#main">Back to top ↑</a></footer></>
}
